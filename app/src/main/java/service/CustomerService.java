...
public class CustomerService {
    ...
    public CustomerService(String authToken) {
    ...
    public String createCustomer(Map<String, Object> customerData) throws IOException {
        String requestBody = convertMapToJson(customerData);
        return sendRequest(baseUrl, "POST", requestBody);
    }

    public String updateCustomer(Map<String, Object> customerData) throws IOException {
        String requestBody = convertMapToJson(customerData);
        return sendRequest(baseUrl, "PUT", requestBody);
    }

    public String deleteCustomer(String customerId) throws IOException {
        return sendRequest(baseUrl + "/" + customerId, "DELETE", null);
    }
